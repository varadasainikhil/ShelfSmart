...
extension OFFANutrientComponent{
    static var mockData : OFFANutrientComponent {
        OFFANutrientComponent(nutrientId: "energy", value: 2172, points: 6, pointsMax: 10, unit: "kJ" )
    }
}
